...
export default function NavWithBreadcrumb({
  ...
  return (
    <SidebarProvider className="" defaultOpen={false}>
      <AppSidebar />
      <SidebarInset className="md:bg-background/95 md:backdrop-blur-md md:border-b w-[calc(100%-var(--sidebar-width))] group-data-[collapsible=icon]:w-[calc(100%-var(--sidebar-width-icon))] min-w-0 flex-1 shrink overflow-x-hidden transition-[width] duration-200 ease-linear">
